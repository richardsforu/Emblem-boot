...
public class CheckinServiceImpl implements CheckinService {
	...
	//private static final String bookingURL = "http://localhost:8085/api/pss";

	@Autowired
	private BookingServiceProxy bookingService;
	...
	*/
	...
	public CheckIn checkIn(long bookingId) {
		...
		BookingRecord bookingRecord=bookingService.book(bookingId);
